...
export const BeanControl = () => {
    ...
    const handleConcatNewBean = async (newBean) => {
    ...
    if (editing && selectedCoffee !== null) {
        visibleState = React.createElement(EditCoffeeForm, { bean: selectedCoffee, onEditCoffee: handleEditList });
        buttonText = "return to list";
    }
    else if (selectedCoffee !== null) {
        visibleState = React.createElement(BeanDetail, { bean: selectedCoffee, onClickingDelete: handleDeleteBean, onClickingEdit: handleEditClick, onClickingSell: handleSellCoffee });
        buttonText = "return to list";
    }
    else if (showForm) {
        visibleState = React.createElement(NewBeanForm, { onCreateBean: handleConcatNewBean });
        buttonText = "return to list";
    }
    else {
        visibleState = React.createElement(BeanList, { list: mainBeanList, onCoffeeSelection: handleChangingSelectedCoffee });
        buttonText = "add a coffee";
    }
    return (React.createElement(React.Fragment, null,
        visibleState,
        React.createElement("span", null,
            React.createElement("button", { id: "form-ticket-button", onClick: handleNewForm }, buttonText))));
};
const beanSeed = [
